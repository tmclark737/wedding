...
jQuery(document).ready(function($) {
    ...
    var $latitude = 37.754604, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
        $longitude = -122.407803,
        $map_zoom = 13; /* ZOOM SETTING */

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var $marker_url = (is_internetExplorer11) ? 'assets/map-marker.png' : '/stampimg/map-marker.svg';
